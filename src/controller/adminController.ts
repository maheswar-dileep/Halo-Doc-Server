...
export const addDoctor = async (req: Request, res: Response) => {
    try {
        ...
        let { firstName, lastName, email, phone, address, department, dob, profile, AuthEmail, password, AuthPhone, photoURL } = req.body
        ...
        let doctor = {
            firstName, lastName, email, phone, address, profile, department, dob, AuthEmail, password, AuthPhone, photoURL
        }
...
export const editBlog = async (req: Request, res: Response) => {
    try {
        ...
        const data = req.body
        const res = BLOG.updateOne({ _id: id }, data)
